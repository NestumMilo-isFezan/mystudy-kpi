    ...
    if (isset($_POST["submitform"])){
        ...
        if(isset($_FILES["fileToUpload"]) &&  $_FILES["fileToUpload"]["name"] == ""){
            $sql = "UPDATE challenge SET sem= '$sem', year ='$year', challenge = '$challenge',
                    ...
                    WHERE ch_id =" . $cid . " AND userID = ". $_SESSION["UID"];   
            ...
            if ($status) {
                ...
                <p class="description">Challenge Record Successfully Edited.<br>';
                ...
                <p class="description">You will be redirected back to Edit Form Page in 5 seconds.</p>';
                header("refresh:5;URL=edit.php?id=$cid");
            }   
        }
        ...
        //IF there is image
            ...
            if($uploadOk){
                ...
                echo '<p class="description">You will be redirected back to the Edit Form Page in 5 seconds.</p>';
                header("refresh:5;URL=edit.php?id=$cid");
            }
        }
    }
        ...
        $cid = $_POST["cid"];
        deletePreviousImage($conn, $cid);
        $sql = "UPDATE challenge SET img_path='' where ch_id=" .$cid. " AND userID=" .$_SESSION["UID"];
        $status = updateTo_DBTable($conn, $sql);
        ...
        if($status){
            ...
            <img class="status-icon" src="../src/img/success.png"/>
            <h1 class="status"><b>Successful</b></h1>
            <p class="description">Challenge Record Picture Successfully Delete.<br>';
            header("refresh:5;URL=../challenge.php");
        }
    }
