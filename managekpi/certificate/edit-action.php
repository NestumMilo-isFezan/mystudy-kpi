...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["submit"])) {
        ...
        $sql = "UPDATE certification SET sem='$sem', year='$year', certification='$name', type='$type', remark='$remark', level='$level' WHERE cert_id=$id";
        ...
        if (mysqli_query($conn, $sql)) {
            ...
            echo'
                ...
                <h1 class="status"><b>Certificate Info Updated</b></h1>
